...
items_lowcost = []
for record_dict1 in log_list:
    if int(record_dict1['item_cost']) < 13000 and record_dict1['item'] not in items_lowcost:
        items_lowcost.append(record_dict1['item'])

print(f'Cписок наименований товаров, дешевле 13000: {items_lowcost}')